...
public class PracticaADatosCrudApp {

    private static final Logger log = LoggerFactory.getLogger(PracticaADatosCrudApp.class);

    private final Environment env;

    public PracticaADatosCrudApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes PracticaADatosCRUD.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PracticaADatosCrudApp.class);
